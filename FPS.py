...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'D:\Desktop\yolo\YOLOv11\yolo11s.pt', help='trained weights path')
    parser.add_argument('--batch', type=int, default=48, help='total batch size for all GPUs')
